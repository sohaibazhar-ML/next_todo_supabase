...
import { LucideIcon, HelpCircle, type LucideProps } from 'lucide-react';

export type IconName = keyof typeof MuiIcons | string;
...
export const AdaptiveIcon = ({ 
    ...
    if (name) {
        const MuiIcon = (MuiIcons as Record<string, any>)[name] as React.ComponentType<any> | undefined;
        if (MuiIcon) {
