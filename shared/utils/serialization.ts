 ...
 * 
 * Usage:
 *   import { serializeDocument, serializeDocuments, serializeProfile } from '@/shared/utils/serialization'
 *   const serialized = serializeDocument(doc)
 *   const profile = serializeProfile(prismaProfile)
 */

import type { Document } from '@/shared/types/document'
import type { SerializedDocument, SerializedVersion, UserVersionRaw } from '@/shared/types/document'
