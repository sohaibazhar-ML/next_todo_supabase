...
import { GtcContentProps } from './GtcContent.types';

export const GtcContent: React.FC<GtcContentProps> = ({ className = '' }) => {
  const t = useTranslations('Gtc');

  // Array of keys for the 14 sections (0 to 13)
  const sectionKeys = Array.from({ length: 14 }, (_, i) => i);
