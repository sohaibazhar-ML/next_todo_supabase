...
describe('Download Logs API', () => {
    ...
    describe('GET', () => {
        it('should return 401 if not authenticated', async () => {
            ...
            const response = await GET(createMockRequest('http://localhost:3000/api/admin/download-logs'))
        ...
        it('should filter by userId for admin', async () => {
            ...
            const url = 'http://localhost:3000/api/admin/download-logs?userId=other-user'
        ...
        it('should filter by both documentId and userId for admin', async () => {
            ...
            const url = 'http://localhost:3000/api/admin/download-logs?documentId=doc-123&userId=user-456'
            await GET(createMockRequest(url))
        ...
        it('should override userId filter for regular user', async () => {
            ...
            const url = 'http://localhost:3000/api/admin/download-logs?userId=malicious-user'
            await GET(createMockRequest(url))
    ...
    describe('POST', () => {
        ...
        it('should return 401 if not authenticated', async () => {
            mockSupabase.auth.getUser.mockResolvedValue({ data: { user: null } })
            const response = await POST(createMockRequest('http://localhost:3000/api/admin/download-logs', {
                method: 'POST',
        ...
        it('should create log successfully with all fields', async () => {
            ...
            const req = createMockRequest('http://localhost:3000/api/admin/download-logs', {
                method: 'POST',
                body: JSON.stringify(validBody),
                headers: {
